...
/**
 * Extension of {@link OAuth2AuthorizationCodeRequestAuthenticationValidator} but without the validation for 'localhost' redirect uri.
 *
 * @see OAuth2AuthorizationCodeRequestAuthenticationValidator
 */
public final class PermissiveOAuth2AuthorizationCodeRequestAuthenticationValidator implements Consumer<OAuth2AuthorizationCodeRequestAuthenticationContext> {
    ...
    public static final Consumer<OAuth2AuthorizationCodeRequestAuthenticationContext> DEFAULT_SCOPE_VALIDATOR =
            PermissiveOAuth2AuthorizationCodeRequestAuthenticationValidator::validateScope;
    ...
    public static final Consumer<OAuth2AuthorizationCodeRequestAuthenticationContext> DEFAULT_REDIRECT_URI_VALIDATOR =
            PermissiveOAuth2AuthorizationCodeRequestAuthenticationValidator::validateRedirectUri;
